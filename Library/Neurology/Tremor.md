...
- Resting
	- *Definition*: Tremor that occurs in a body part that is relaxed and completely supported against gravity. Enhanced by mental stress (counting backwards) or movement of another body part. Diminished by voluntary movement of the involved body part.
	- Enhanced physiologic tremor: normal physiologic tremor that can become more apparent with anxiety, stress, caffeine, medications, and metabolic conditions (hyperthyroidism).
- Action: Tremor that occurs with voluntary muscle action.
	- Postural: Tremor present while maintaining a position against gravity
	- Isometric: Occurs with muscle contraction against a rigid stationary object (like when making a fist)
	- Kinetic: Associated with voluntary movement
		- Intention: a type of kinetic tremor produced with target-directed movement

## Differential Diagnosis for a Tremor
Tremor
- Resting
...
- Other:	
	...
	- Alcohol withdrawal
	- Wilson disease: sometimes wing beating
	- Fragile X syndrome
